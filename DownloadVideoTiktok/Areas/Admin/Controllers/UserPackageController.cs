...
{    
    public class UserPackageController : BaseAdminController
    {
        private readonly ILogger<UserPackageController> _logger;
        private readonly UserPackageService userPackageService;

        public UserPackageController(ILogger<UserPackageController> logger,
        ...
        public ActionResult Index()
        {
            ...
            (var list, var total) = userPackageService.Get(keyword, (page - 1) * pageSize, pageSize);

            var model = new PageListModel<UserPackage>
            {
                List = list,
                Total = total,
                PageSize = 10,
        ...
        {
            var item = userPackageService.Get(id);
