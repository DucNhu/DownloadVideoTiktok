...
{    
    public class HistoryDownloadController : BaseAdminController
    {
        private readonly ILogger<HistoryDownloadController> _logger;
        private readonly HistoryDownloadService historyDownloadService;

        public HistoryDownloadController(ILogger<HistoryDownloadController> logger,
        ...
        public ActionResult Index()
        {
            ...
            (var list, var total) = historyDownloadService.Get(keyword, (page - 1) * pageSize, pageSize);
